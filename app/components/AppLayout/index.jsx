...
const AppLayout = ({ children }) => {
  return (
    <div className={cn("app-layout", "relative flex h-dvh w-full flex-col overflow-hidden bg-cs-bg")}>
      <div className={cn("app-layout-backdrop", "pointer-events-none absolute inset-0 overflow-hidden")} aria-hidden="true">
        <div
          className={cn(
            "app-layout-grid",
